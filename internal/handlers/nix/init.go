...
type NixInitHandlerInputs struct {
	IsDefault        bool
...
func NixInitHandler(isCli bool, params NixInitHandlerInputs) error {
	...
	if _, err := os.Stat(configPath); err == nil {
		...
		if backupErr != nil {
			logging.Logger.Warn("Failed to create backup before nix init",
...
func setParameters(isCli bool, config *models.Config, params NixInitHandlerInputs) error {
